...
public class ProfileActivityViewModel extends BaseViewModel<AccountSettingsNavigator> {

    private static final String TAG = ProfileActivityViewModel.class.getSimpleName();
     ...
     */
    public ProfileActivityViewModel(Context context, FirebaseAuth firebaseAuth, FirebaseDatabase firebaseDatabase, FirebaseStorage firebaseStorage) {
