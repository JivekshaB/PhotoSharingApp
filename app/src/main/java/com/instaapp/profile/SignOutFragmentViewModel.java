...
public class SignOutFragmentViewModel extends BaseViewModel<SignOutFragmentNavigator> {

    private static final String TAG = SignOutFragmentViewModel.class.getSimpleName();
     ...
     */
    public SignOutFragmentViewModel(Context context, FirebaseAuth firebaseAuth, FirebaseDatabase firebaseDatabase, FirebaseStorage firebaseStorage) {
